...
setup(
    ...
    version=get_version(),
    license='Apache-2.0',
    description='Utility for trace sources and binaries codebase builds and transforms.',
    long_description=read('README.rst'),
    author='nexB Inc.',
    author_email='info@nexb.com',
    url='https://github.com/nexb/tracecode-toolkit',
